    ...
    useEffect(() => {
       ...
       useEffect(() => {
           ...
           socket && socket.emit("join", {
            ...
            socket && socket.on("joined", ({clients, name, socketId}) => {
             ...
             socket &&  socket.on("disconnected", ({socketId, name}) => {
                 setClients((prev) => {
      ...
      >
        ...
        <div className='mt-4 flex gap-2 justify-center items-center'>
           ...
           <div className='mt-auto flex flex-col gap-2 items-center mb-4'>
                    ...
                    <button onClick={() => navigate("/")} className='px-10 py-2 bg-slate-400 border-none outline-none shadow-md mt-2  font-semibold hover:bg-[#f5f5f5] rounded-lg ' >Leave</button>
                    <button onClick={handleCopyRoomId} className='px-10 py-2 bg-slate-400 border-none outline-none shadow-md mt-2  font-semibold hover:bg-[#f5f5f5] rounded-lg ' >Copy Room Id</button>
            </div> 
      </div>
        ...
        <div className={` col-span-6  bg-[#f5f5f5] h-[100vh]  `}>
               ...
               <TextEditor socket= {socket}  roomId={Id} onCodeChange={() => {}} />
        </div>
    </div>
  )
}
